...
<body>
  ...
  <div class="container">
    <img src="{{asset('images/alon-alon.jpg')}}" class="img-fluid" style="width: 80%; height: 400px; margin-left: 10%;" alt="...">
  </div>
<br>
<div class="container">
    <div>
  ...
  <div class="slider">
    <div class="list">
        <div class="item">
            <img src="{{asset('images/thumbnaill3.jpg')}}" alt="">
        </div>
        <div class="item">
            <img src="{{asset('images/thumbnail2.webp')}}" alt="">
        </div>
        <div class="item">
            <img src="{{asset('images/cobankromo.jpeg')}}" alt="">
        </div>
    </div>
    <div class="buttons">
        <button id="prev">
...
<div>
    ...
    <div class="container text-center">
        ...
        @foreach ($posts as $post)
          <div class="col">
            <h1 style="margin-bottom: 20px">{{ $post->nama_tempat}}</h1>
            <a href="{{route('detail', $post->id) }}">
              <img src="{{asset('images/'. $post->gambar)}}" alt="" style="width: 20rem; height:250px; margin-bottom:60px;" >
            </a>
          </div>
        @endforeach
        </div>
