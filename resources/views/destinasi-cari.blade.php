          ...
          <div class="row">
            ...
            <div class="col">
              @foreach ($posts as $post)
                ...
                <img src="{{asset('images/'.$post->gambar)}}" alt="" style="margin-bottom: 25px; width:100%; height:300px;" >
                </a>
              @endforeach
            </div>
            <div class="col">
              @foreach ($posts as $post)
                <div style="">
                  <a style="text-decoration: none; color:black;" href="{{route('detail',$post->id)}}">
                    <h4 style=" text-align:start;">
                      {{$post->nama_tempat}}
                      <p style="padding-bottom:180px; margin-bottom:35px; margin-top:20px">{{$post->lokasi_tempat}}</p>
                    </h4>
                  </a>
