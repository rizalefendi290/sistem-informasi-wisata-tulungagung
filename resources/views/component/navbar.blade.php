...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
        <div class="container">
            <img src="{{asset('images/icon.png')}}" width="100px" height="100px" alt="">
          <a href="{{route('home')}}" style="text-decoration: none;"><h1 class="navbar-brand">TripTulungagung</h1></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              <a class="nav-link" aria-current="page" href="{{route('tentangkita')}}">Tentang Kita</a>
              <a class="nav-link" href="{{route('destinasi')}}">Destination</a>
