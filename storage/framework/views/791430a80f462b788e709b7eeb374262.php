...
<body>
    ...
    <div class="container">
            <h1 class="home-tag" style="text-align: start; margin-top:20px;"><?php echo e($post ->nama_tempat); ?></h1>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <p><i class="fa-solid fa-clock-rotate-left" style="color: #000000; margin-right: 10px;"></i>Durasi
                        <?php echo e($post->jarak_tempuh); ?></p>
                    <p><i class="fa-solid fa-location-pin" style="color: #000000; margin-right: 10px;"></i><?php echo e($post->lokasi_tempat); ?></p>
                    <p><?php echo e($post->keterangan); ?></p>
                </div>
                <div class="col">
                    <div id="carouselExampleIndicators" class="carousel slide" style="margin-left: 50px;">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="<?php echo e(asset('images/'.$post->gambar)); ?>" class="d-block w-100" alt="..."
                                    style="width: 1000px; height: 600px; object-fit:cover;">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo e(asset('images/penampihan.webp')); ?>" class="d-block w-100" alt="..."
                                    style="width: 1000px; height: 600px; object-fit: cover;">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo e(asset('images/penampihan3.jpg')); ?>" class="d-block w-100" alt="..."
                                    style="width: 1000px; height: 600px; object-fit: cover;">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo e(asset('images/puncakwilis (1).jpeg')); ?>.jpeg" class="d-block w-100" alt="..."
                                    style="width: 1000px; height: 600px; object-fit: cover;">
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo e(asset('images/puncakwilis (2).jpeg')); ?>.jpeg" class="d-block w-100" alt="..."
                                    style="width: 1000px; height: 600px; object-fit: cover;">
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="container text-center">
                            <div class="row">
                                <div class="col">
                                    <p style="margin-left: 40px;"><?php echo e($post->ulasan); ?>/10</p>
                                </div>
                                <div class="col">
                                    <div class="progress" role="progressbar" aria-label="Example with label"
                                        aria-valuenow="<?php echo e($post->ulasan); ?>" aria-valuemin="<?php echo e($post->ulasan); ?>" aria-valuemax="100"
                                        style="margin-left: -100px; height: 20px;">
                                        <div class="progress-bar" style="width: 80%"><?php echo e($post->ulasan); ?>/10</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="round-image">
                                <img src="<?php echo e(asset('images/profil.jpg')); ?>" alt="Gambar">
                            </div>
                        </div>
                        <div class="col">
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col">
                        <a href="<?php echo e(route('detail', $post->id)); ?>" style="color:#000000; text-decoration:none;">
                            <img src="<?php echo e(asset('images/'.$post->gambar)); ?>" alt=""
                            style="width: 400px; height: 300px;">
                            <h4 style="text-align: start;"><?php echo e($post->nama_tempat); ?></h4>
                            <p style="text-align: start;"><?php echo e($post->lokasi_tempat); ?></p>
                        </a>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\wisata\resources\views/detail.blade.php ENDPATH**/ ?>